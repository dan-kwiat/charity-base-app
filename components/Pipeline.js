function MergeSourcesHorizontal() {
  return (
    <pre className="hidden md:block font-mono text-pink-600 text-xl">
      {`----------->      
-------------->   
--- `}
...
export default function Pipeline() {
  return (
    <div className="overflow-hidden w-full max-w-4xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center space-y-12 md:space-y-0 md:space-x-2">
      <Card>
